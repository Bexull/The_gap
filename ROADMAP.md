...
### Исправление двойного назначения спец-заданий одному ОПВ
**Проблема:** Планировщик мог назначить несколько спец-заданий одному и тому же ОПВ в одной итерации.
...
**Исправления:**
1. ✅ **task_scheduler.py (строка 117)** - добавлена переменная `assigned_opv_ids = set()` для отслеживания назначенных ОПВ
...
**Результат:** Теперь каждый ОПВ может получить только одно спец-задание за итерацию планировщика.
